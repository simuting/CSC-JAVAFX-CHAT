package src.traynotifications.notification;
...
import src.traynotifications.animations.*;
import src.traynotifications.models.CustomStage;
...
public final class TrayNotification {
    ...
    public TrayNotification(String title, String body, Image img, Paint rectangleFill) {
        System.out.println("TrayNotification.trayNotification1 is used");
    ...
    public TrayNotification(String title, String body, NotificationType notificationType ) {
        System.out.println("TrayNotification.TrayNotification2 is used");
    ...
    public TrayNotification() {
        System.out.println("TrayNotification.TrayNotification3 is used");
    ...
    private void initTrayNotification(String title, String message, NotificationType type) {
        System.out.println("TrayNotification.initTrayNotification is used");
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("TrayNotification.fxml"));
    ...
    private void initAnimations() {
        System.out.println("TrayNotification.initAnimations is used");
    ...
    private void initStage() {
        System.out.println("TrayNotification.initStage is used");
    ...
    public void setNotificationType(NotificationType nType) {
        System.out.println("TrayNotification.setNotificationType is used");
    ...
    public NotificationType getNotificationType() {
        System.out.println("TrayNotification.NotificationType is used");
        return notificationType;
    }

    public void setTray(String title, String message, NotificationType type) {
        System.out.println("TrayNotification.setTray1 is used");
        setTitle(title);
        setMessage(message);
    ...
    public void setTray(String title, String message, Image img, Paint rectangleFill, AnimationType animType) {
        System.out.println("TrayNotification.setTray2 is used");
        setTitle(title);
        setMessage(message);
        setImage(img);
        setRectangleFill(rectangleFill);
    ...
    public boolean isTrayShowing() {
        System.out.println("TrayNotification.isTrayShowing is used");
    ...
    public void showAndDismiss(Duration dismissDelay) {
        System.out.println("TrayNotification.showAndDismiss is used");
        if (isTrayShowing()) {
            dismiss();
        } else {
            stage.show();
    ...
    public void showAndWait() {
        System.out.println("TrayNotification.showAndWait is used");
     ...
     */
    public void dismiss() {
        System.out.println("TrayNotification.dismiss is used");
    ...
    private void onShown() {
        System.out.println("TrayNotification.onShown is used");
        if (onShownCallback != null)
            onShownCallback.handle(new ActionEvent());
    }

    private void onDismissed() {
        System.out.println("TrayNotification.onDismissed is used");
    ...
    public void setOnDismiss(EventHandler<ActionEvent> event) {
        System.out.println("TrayNotification.setOnDismiss is used");
    ...
    public void setOnShown(EventHandler<ActionEvent> event) {
        System.out.println("TrayNotification.setOnShown is used");
    ...
    public void setTrayIcon(Image img) {
        System.out.println("TrayNotification.setTrayIcon is used");
        stage.getIcons().clear();
        stage.getIcons().add(img);
    }

    public Image getTrayIcon() {
        System.out.println("TrayNotification.getTrayIcon is used");
    ...
    public void setTitle(String txt) {
        System.out.println("TrayNotification.setTitle is used");
        lblTitle.setText(txt);
    }

    public String getTitle() {
        System.out.println("TrayNotification.getTitle is used");
    ...
    public void setMessage(String txt) {
        System.out.println("TrayNotification.setMessage is used");
        lblMessage.setText(txt);
    }

    public String getMessage() {
        System.out.println("TrayNotification.getMessage is used");
        return lblMessage.getText();
    }

    public void setImage (Image img) {
        System.out.println("TrayNotification.setImage is used");
    ...
    public Image getImage() {
        System.out.println("TrayNotification.getImage is used");
        return imageIcon.getImage();
    }

    public void setRectangleFill(Paint value) {
        System.out.println("TrayNotification.setRectangleFill is used");
        rectangleColor.setFill(value);
    }

    public Paint getRectangleFill() {
        System.out.println("TrayNotification.getRectangleFill is used");
        return rectangleColor.getFill();
    }

    public void setAnimationType(AnimationType type) {
        System.out.println("TrayNotification.setAnimationType is used");
    ...
    public AnimationType getAnimationType() {
        System.out.println("TrayNotification.getAnimationType is used");
